...
class Team_Carousel extends Widget_Base {
    ...
    protected function render() {
        ...
        echo '<div class="owl-carousel owl-theme dot-style-2 nav-inside nav-circle-solid-light px-md-0 px-3" data-items="[4,2]" data-margin="30" data-loop="true" data-autoplay="true" data-dots="true">';
        foreach($settings['team_members'] as $team_member){
            ...
            <div class="item">
                <div class="card border-0 mb-md-0 mb-3">
                    <img class="card-img-top" src="<?php echo esc_url($image) ;?>" alt="<?php echo esc_attr($testimonial['name']) ;?>">
