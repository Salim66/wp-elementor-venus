 ...
 * @since 1.0.0
 */
class Minimul_Team_Member extends Widget_Base {
	...
	public function get_title() {
		return __( 'Minimul Team Member', 'venus-companion' );
	}
	...
	protected function render() {
		...
		<div class="card border-0 mb-4 box-hover">
			<img class="card-img-top" src="<?php echo esc_html($settings['photo']['url']); ?>" alt="">
			<div class="team-footer border-0">
